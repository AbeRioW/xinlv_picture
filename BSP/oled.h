...
#define OLED_SCL_Clr() 	HAL_GPIO_WritePin(GPIOA,OLED_SCL_Pin,GPIO_PIN_RESET)//SCL
#define OLED_SCL_Set()	HAL_GPIO_WritePin(GPIOA,OLED_SCL_Pin,GPIO_PIN_SET)

#define OLED_SDA_Clr() 	HAL_GPIO_WritePin(GPIOA,OLED_SDA_Pin,GPIO_PIN_RESET)//SDA
#define OLED_SDA_Set() 	HAL_GPIO_WritePin(GPIOA,OLED_SDA_Pin,GPIO_PIN_SET)
